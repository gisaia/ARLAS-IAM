...
import io.arlas.iam.filter.impl.Auth0PolicyEnforcer;
import io.arlas.iam.filter.impl.HTTPPolicyEnforcer;
import io.arlas.iam.filter.impl.KeycloakPolicyEnforcer;

module arlas.iam.filter {
    exports io.arlas.iam.filter.impl;
    exports io.arlas.iam.config;
